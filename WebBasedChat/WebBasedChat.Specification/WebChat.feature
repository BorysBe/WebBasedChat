...
Scenario: Get last 30 messages
	...
	And User click "Create new room" button
	And User click "Create new room" button
	And User 4 join chat room 1
	And User 5 join chat room 2
	...
	Then Following messages was send to user 4
	| message   | nick   | date   |

	And Following messages was send to user 5
	| message   | nick   | date   |

	And Following messages was send to user 1
	| message   | nick   | date   |
